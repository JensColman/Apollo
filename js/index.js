function main() {
    ...
    if (window.location.href.match('vragenlijst.html') !== null || window.location.href.match('vragenlijstLector.html') !== null) {
    ...
    } //end if (window.location.href.match('vraag.html') !== null) {}

    if (window.location.href.match('vragenlijst.html') !== null || window.location.href.match('vraag.html') !== null ||  window.location.href.match('vragenlijstLector.html') !== null) {
        //upvote systeem
        var rating = document.getElementsByClassName("rating");

        for (i = 0; i < rating.length; i++) {
            rating[i].addEventListener("click", function(x) {
                x.preventDefault();
        ...
        }//end if (window.location.href.match('vragenlijst.html') !== null || window.location.href.match('vraag.html') !== null ||  window.location.href.match('vragenlijstLector.html') !== null) {}
    }
}//end function main()
